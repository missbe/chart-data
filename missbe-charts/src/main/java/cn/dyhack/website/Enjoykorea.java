...
public class Enjoykorea {
    ...
    {
    	return date+" :"+Url.toString();
    	//return "Enjoykorea["+"id:"+id+"author:"+author+"view:"+view+"comment:"+comment+"content:"+content+"date:"+date+"]";
