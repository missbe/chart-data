...
import cn.dyhack.website.Enjoykorea;
...
public class HappyKorea_Activepersonnelrank implements PageProcessor {
	    ...
	    public void process(Page page) {
           ...
           if (page.getUrl().regex(URL_LIST).match()) {
	    		...
	    		*/
	        	...
	        	new DBConnection().AddtoMysql_EnjoyKorea_PostnumbRank(page.getHtml().xpath("//*[@id=\"ct\"]/div[1]/div[2]/div[1]/dl/dt[2]/a/text()").all(), page.getHtml().xpath("//*[@id=\"ct\"]/div[1]/div[2]/div[1]/dl/dd[3]/p/a/text()").all(),"乐在韩国");
	            //enjoykorea.toString();
	    ...
	    public static void main(String[] args) {
	        ...
	        Spider.create(new HappyKorea_Activepersonnelrank()).addUrl("http://bbs.enjoykorea.net/misc.php?mod=ranklist&type=member&view=post&orderby=thismonth").addPipeline(new ConsolePipeline()).thread(1).run();
