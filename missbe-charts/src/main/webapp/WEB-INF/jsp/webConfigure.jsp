<%@page import="cn.missbe.app.HappyKorea"%>
			...
			<nav class="navbar navbar-static-top">
				...
				<div class="navbar-custom-menu">
					<ul class="nav navbar-nav">
						...
						<li class="user user-menu pull-right"><a
							href="${basePath}index.action" class="btn btn-lg btnapp">退出</a></li>
						<li></li>
						<li></li>
					</ul>
				</div>
	   ...
	   <li class="treeview active">
		...
		<div class="content-wrapper">
			...
			<section class="content">
				<%
					List<HappyKorea> userList = (List<HappyKorea>) request.getAttribute("userList");
					int end = 0;
					if (null != userList) {
						end = userList.size();
					}
